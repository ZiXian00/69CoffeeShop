...
namespace _69CoffeeShop.Forms
{
    public partial class FormAdminLogin : Form
    {
        ...
        {
            string newEmpQry = "update backup_record set backup_datetime = @date where backup_id = 6";
            MySqlCommand newEmpCmd = new MySqlCommand(newEmpQry, connection.conn);
            connection.conn.Open();

            //try
            //{
                newEmpCmd.Parameters.AddWithValue("@date", Class.Utilities.encryption("08 Nov 2021 20:00"));
